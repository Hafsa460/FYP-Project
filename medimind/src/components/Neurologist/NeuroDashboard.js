    ...
    <div className="neuro-dashboard d-flex">
      ...
      <div className="sidebar p-3">
        <div className="doctor-profile d-flex align-items-center mb-4">
          <img src={femaleProfile} alt="Female Doctor" className="profile-icon me-3" />
          <div className="doctor-name fw-semibold">Dr. John Doe</div>
        </div>

        <ul className="nav flex-column">
          <li className="nav-item">
            <Link to="verify-reports" className="nav-link">Verify Test Reports</Link>
          </li>
          <li className="nav-item">
            <Link to="prescription-history" className="nav-link">View Prescription History</Link>
          </li>
          <li className="nav-item">
            <Link to="profile-management" className="nav-link">Profile Management</Link>
          </li>
          <li className="nav-item">
          ...
          <div className="top-section">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <div className="text-secondary">You have 19 appointments today</div>
              </div>
            </div>
          </div>
          ...
          <div className="bottom-grid mt-4">
            ...
            <div className="block-section flex-grow-1 ms-3">
              ...
              <table className="table table-bordered mb-0" id="id3">
                ...
                <tbody>
                  <tr><td>award1</td><td>2021</td></tr>
                  <tr><td>award2</td><td>2022</td></tr>
                  <tr><td>award3</td><td>2019</td></tr>
                  <tr><td>award4</td><td>2019</td></tr>
                </tbody>
              </table>
            </div>
          </div>
